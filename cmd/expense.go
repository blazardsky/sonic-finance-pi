...
type expense struct {
	...
	// How many units of HoldingID this buy paid for — optional (schema step
	// 17), typed by hand same as an Item's own Quantity, and meaningless
	// without a HoldingID alongside it (nothing enforces that pairing the way
