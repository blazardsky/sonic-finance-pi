...
- [ ] Each Planned purchase shows its month, or the "non rientra" state with the missing amount and the Savings answer
- [ ] Each month row lists the Planned purchases that land in it
- [ ] Reordering the list re-places the purchases immediately
- [ ] With the projection unavailable (under 3 months of history), no purchase shows a month
- [ ] Tests: priority order decides who gets Headroom first; a purchase that doesn't fit consumes nothing and a smaller later one still lands; missing amount = amount − balance at the end of the horizon after higher-priority placements; Savings cover when Savings ≥ missing amount
